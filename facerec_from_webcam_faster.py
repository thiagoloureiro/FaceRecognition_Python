...
thiago_image = face_recognition.load_image_file("thiago.jpg")
thiago_face_encoding = face_recognition.face_encodings(thiago_image)[0]

marcos_image = face_recognition.load_image_file("marcos.jpg")
...
antonio_image = face_recognition.load_image_file("antonio.jpg")
...
jorge_image = face_recognition.load_image_file("jorge.jpg")
jorge_face_encoding = face_recognition.face_encodings(jorge_image)[0]

elzbieta_image = face_recognition.load_image_file("elzbieta.jpg")
elzbieta_face_encoding = face_recognition.face_encodings(elzbieta_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    thiago_face_encoding,
    marcos_face_encoding,
    gabriel_face_encoding,
    antonio_face_encoding,
    humberto_face_encoding,
    jorge_face_encoding,
    elzbieta_face_encoding
]
known_face_names = [
    "Thiago",
    "Marcos",
